...
target_compile_definitions(ArduinoCore INTERFACE
#     "ARDUINO=${ARDUINO_VERSION}"
#     "ARDUINO_${ARDUINO_BOARD}"
    "ARDUINO_ARCH_AVR"
)

target_link_libraries(ArduinoCore PUBLIC AvrFlags)
